...
const imageData1 = [
    ...
    'https://theesaan-enterprises-server.herokuapp.com/sites/adage/data/visual-data/r4_3.jpg',
...
const Work1 = () => {
    ...
    return(
        <div className="__te_adageInteriorStudio__WorkModules">
            ...
            <AdvancedParallaxBox img1Src = {imageData1[3]} img2Src = {imageData1[0]}/>
            <ParallaxBox img1Src = {imageData1[4]} img2Src = {imageData1[1]} img3Src = {imageData1[4]}/>
            <Link to = '/work/work2'>

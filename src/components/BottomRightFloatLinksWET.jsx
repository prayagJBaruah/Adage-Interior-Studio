...
const BottomRightFloatLinks = ({children, routeName}) => {
    ...
    return(
        <animated.li className = "__te_adageInteriorStudio__BottomRightFloat_desktopMenuList__listItems" onMouseEnter = {e => set(true)} onMouseLeave = {e => set(false)} style = {(currRoute === routeName)?self_link_animProps_routeIndicator:self_link_animProps}>{children}</animated.li>
    )
}


//exporting component here:
export default BottomRightFloatLinks;
...
const AdvancedParallaxBox = () => {
    ...
    return(
        <animated.div className="__te_adageInteriorStudio__AdvancedParallaxBox_Studio">
            <animated.img style = {{transform:props.y.interpolate( y => `translateY(${-y/y}px)`)}} className = "_te__adageInteriorStudio__ReactiveImages" id = "_te__adageInteriorStudio__AdvancedParallaxBox_reactiveImages_Studio1" src = "https://theesaan-enterprises-server.herokuapp.com/sites/adage/data/visual-data/arch8.jpg"/>
            ...
            //     })
            // }}
            style = {self_AdvancedImages_style} className = "_te__adageInteriorStudio__ReactiveImages" id = "_te__adageInteriorStudio__AdvancedParallaxBox_reactiveImages_Studio2" src = "https://theesaan-enterprises-server.herokuapp.com/sites/adage/data/visual-data/arch8.jpg"/>
        </animated.div>
    )
}
